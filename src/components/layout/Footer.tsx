      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your premier destination for discovering, exploring, and purchasing books online. 
              We offer a curated selection of titles across all genres.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 BookHaven. All rights reserved. Built with React, TypeScript & Supabase.
          </p>
        </div>
      </div>
    </footer>
